...
public class SimpleTest {
    ...
    public void test12() throws SQLException, IOException {
        SunlineUtil.sunlineSearchDict("last_update_date");
    }
    ...
    public void test36() throws Exception {
        List<String> filePathList = SunlineUtil.sunlineGetMergedFiles(E_STRUCTMODULE.BUSI, "ln-busi", "835");
    ...
    public void test51() throws Exception {
        while (true) {
            MapperFactory.getTspTaskExecutionMapper(BatTaskUtil.batConfig.getDatasource()).selectByPrimaryKey(new TspTaskExecutionKey("Middle_20191109_025", "1590666282145", "2019-11-10", BatTaskUtil.batConfig.getSubSystemId(), BatTaskUtil.batConfig.getSystemCode(), BatTaskUtil.batConfig.getBusiOrgId()));
